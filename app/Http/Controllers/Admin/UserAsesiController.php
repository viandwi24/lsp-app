...
class UserAsesiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.admin.user.asesi.index');
    }
    ...
    {
        return view('pages.admin.user.asesi.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $store = UserService::make('asesi', $request->nama, $request->email, $request->password, []);
        return redirect()->route('admin.user.asesi.index')
    ...
    {
        $user = User::find($id);
        return view('pages.admin.user.asesi.edit', compact('user'));
    }
