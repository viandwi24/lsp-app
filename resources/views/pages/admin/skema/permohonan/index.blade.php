                ...
                columns: [
                    ...
                    { data: 'created_at' },
                    {
                        ...
                        render: (data, type, row) => `
                            <div>
                                <a href="{{ route('admin.skema.permohonan.index', [$skema->id]) . '/' }}`+data.id+`" class="btn btn-sm btn-success"><i class="ft-edit-3"></i></a>
                                <form method="post" action="{{ route('admin.skema.permohonan.index', [$skema->id]) . '/' }}`+data.id+`" style="display: inline-block;">
                                    @method('delete')
                                    @csrf
