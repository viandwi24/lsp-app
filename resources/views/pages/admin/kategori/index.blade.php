@extends('layouts.dashboard', ['title' => 'Admin \ Kategori'])
...
@section('content')
    <!-- content-header -->
    <x-dashboard-content-header title="Manajemen Kategori" :breadcrumb="$breadcrumb" />
                        ...
                        columns: [
                            ...
                            { data: 'deskripsi' },
                            {
                                ...
                                render: (data, type, row) => `
                                    <div>
                                        <a href="{{ url()->route('admin.kategori.index') . '/' }}`+data.id+`/edit" class="btn btn-sm btn-warning"><i class="ft-edit"></i></a>
                                        <form method="post" action="{{ url()->route('admin.kategori.index') . '/' }}`+data.id+`" style="display: inline-block;">
                                            @method('delete')
                                            @csrf
